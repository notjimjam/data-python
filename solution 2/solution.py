...
colors = ['green', 'blue', 'magenta', 'orange', 'purple']
...
# Determine if the letter grade of the given variable 'score'. If the variable is a 90 or above, print an 'A', between 80 and 89, print a 'B', between 70 and 79, 'C', between 60 and 69, 'D', and anything below 60 should print an 'F'.
if score >= 90:
  print("A")
elif score >= 80:
  print("B")
...
# Problem 11
# Create a variable called 'change_my_mind' and set it equal to a boolean of your choice. 
